...
<main class="bg-[#C0D5EA] relative ungated pb-[5rem]">
    ...
    <div class="container relative z-10 max-lg:px-0">
        <?php if($image) : ?>
            <div class="lg:flex hidden w-full flex-col gap-[2rem] md:h-[45rem] h-[31rem] bg-cover bg-no-repeat overflow-hidden rounded-b-[5rem]" 
                style="background-image: url(<?php echo $image; ?>); background-position: 0 40%">
                &nbsp;
            </div>
        <?php endif; ?>  
